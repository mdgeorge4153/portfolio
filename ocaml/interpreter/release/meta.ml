(**
 * Yo dawg, I heard you like interpreters, so I put an interpreter in your
 * interpreter so you could interpret some extra examples and
 * test cases while you interpret your interpreter
 *)
