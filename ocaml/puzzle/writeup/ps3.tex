...
\newcommand{\tilepicture}[2]{\includegraphics[width=#1]{images/tile#2.png}}

\node[state] (init) at ( 0, 0) {\tilepicture{1.5cm}{}};
\node[state] (n)    at ( 0, 4) {\tilepicture{1.5cm}{N}};
\node[state] (e)    at ( 4, 0) {\tilepicture{1.5cm}{E}};
\node[state] (en)    at ( 4, 4) {\tilepicture{1.5cm}{EN}};
...
\node[state] (sol) at (10, 0) {\tilepicture{1.5cm}{sol}};
