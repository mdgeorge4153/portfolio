...
let _ = print_endline "--- Ints Testing --- \n" 
...
let _ = print_endline "-- Following ints tests should fail -- \n"  
let () = TestInts.test [] [n_of_i max_int]

let _ = print_endline "--- Integers Testing --- \n" 
...
let _ = print_endline "-- No integers tests should fail -- \n" 

let _ = print_endline "--- Floats Testing --- \n "
...
let () = TestFloats.test [] []
let _ = print_endline "--- Floats Testing the following should fail --- \n " 
let e7 = Numbers.Floats.inv (n_of_i 100000)
let () = TestFloats.test [] [e7]


let _ = print_endline "--- Root23 Testing --- \n" 
...
let () = TestRoot23.test [] []
let _ = print_endline "--- Root23 Identity Testing --- \n"
let _ = test_identities_root23 ()


let _ = print_endline "--- Rot15 Testing --- \n"
...
let _ = print_endline "--- Rot15 Identity Testing --- \n"
let _ = test_identities_rot15 ()


let _ = print_endline "--- Rationals Testing --- \n"
